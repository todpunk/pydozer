...
second_post.author = 'Also Not Tod'
second_post.tags = ['third', 'testing', 'generated']  # Yes, I tagged it third.
...
second_post.posted_date = dateutil.parser.parse('Fri Sep 26 20:36:28 MST 2003')
second_post.data['title'] = 'Oh hello, oh hello, second post to you'
second_post.filename = slugify(unicode(second_post.data['title']))
...
""" % (second_post.data['config']['blog_base_dir'], first_post.filename, first_post.data['title'])
